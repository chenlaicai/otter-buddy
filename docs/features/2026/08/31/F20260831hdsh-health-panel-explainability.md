...
summary: D2 架构稳定线性×4封顶校准 + 五维雷达/综合分评分「?」公式说明 + 特性链 docTitle/stateReason + 信号 signalTypeLabel 补料与人话化
---
...
设计意图：每个热区扣4分，总扣封顶60。20个热区得分 40 分。原方案为分段递减，实现简化为纯线性×4，20 热区落点 40 分仍在目标区间附近。
...
- D2 线性×4封顶单测覆盖 0/5/10/20/100 热区边界
