...
- **单测**（36 个新增）：D1 公式边界（0/0.05/0.2/0.3/0.4/0.9）+ clamp 上下界、D2 失衡与 clamp、D3 惩罚系数与归因、D5 活跃链口径与零链降级、状态分级边界（49.9/50/74.9/75）、走向判定（±5 严格大于边界、不足 8 点 null、null 点剔除）、综合分权重归一、health_index 行构建
