...
3. 按结论修订方案并复审。第 2 轮起是 **delta 审视**：把上轮发现清单 + 你的逐条处置 + 修订 diff 发给检视獭（轮次结构与检视者职责定义见 `adversarial-review/references/review-loop.md`）。复审按收敛判据运转：不设轮数上限，对立僵局 / 移动靶 / 僵尸循环任一信号 → 呈搭档裁决
