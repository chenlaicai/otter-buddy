...
const WORKSPACE = path.resolve(__dirname, '../../../../../data/workspaces/2006bca9-d162-40b6-b8e1-11ec3807300d')
...
test.describe('SPA 路由截图验证', () => {
  test('根路径 / 重定向到 /conversation', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-home.png'), fullPage: true })
  })
  ...
  test('深链接直达 /memory 不 404', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-memory.png'), fullPage: true })
  })
  ...
  test('深链接直达 /skills 不 404', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-skills.png'), fullPage: true })
  })
  ...
  test('深链接直达 /settings 不 404', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-settings.png'), fullPage: true })
  })
  ...
  test('深链接直达 /im 不 404', async ({ page }) => {
    ...
    await expect(page.locator('header')).toBeVisible()
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-im.png'), fullPage: true })
  })
  ...
  test('深链接直达 /health 不 404', async ({ page }) => {
    ...
    await expect(page.locator('header')).toBeVisible()
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-health.png'), fullPage: true })
  })
  ...
  test('深链接直达 /activity 不 404', async ({ page }) => {
    ...
    await expect(page.locator('header')).toBeVisible()
    await page.screenshot({ path: path.join(WORKSPACE, 'spa-activity.png'), fullPage: true })
  })
