...
export const smallOtters: Otter[] = [
  { id: 'o2', name: '分析獭', type: 'small', role: { name: '方案A视角', resp: ['从用户体验角度分析', '关注易用性'] }, parentOtterId: 'o1', ci: 1 },
  { id: 'o3', name: '测试獭', type: 'small', role: { name: '方案B视角', resp: ['从技术架构角度分析', '关注可维护性'] }, parentOtterId: 'o1', ci: 2 },
]
