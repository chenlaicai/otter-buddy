  ...
  <BrowserRouter>
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route path="conversation" element={<Suspense fallback={<LoadingFallback />}><ConversationListPage /></Suspense>} />
        <Route path="conversation/:id" element={<Suspense fallback={<LoadingFallback />}><ConversationPage /></Suspense>} />
        <Route path="memory" element={<Suspense fallback={<LoadingFallback />}><MemorySearchPage /></Suspense>} />
        <Route path="skills" element={<Suspense fallback={<LoadingFallback />}><SkillsPage /></Suspense>} />
        <Route path="im" element={<Suspense fallback={<LoadingFallback />}><ImPage /></Suspense>} />
        <Route path="health" element={<Suspense fallback={<LoadingFallback />}><HealthPage /></Suspense>} />
        <Route path="activity" element={<Suspense fallback={<LoadingFallback />}><ActivityPage /></Suspense>} />
