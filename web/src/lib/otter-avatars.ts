 ...
 * - 用户显式自选的头像存 localStorage override（F20260826ucrt），
 ...
 *  F20260826ucrt：导出供创建弹窗九宫格渲染（只读消费，不修改池内容） */
 ...
 * 用户自选（F20260826ucrt）；大獭/用户头像不受 override 影响
 */
...
/**
 * 写入/清除小獭头像 override（F20260826ucrt UI 自选）。
 ...
 * 小獭优先读 localStorage override（F20260826ucrt），未命中走 hash 池——
 * 未自选的獭路径与改前逐位一致。
 */
