...
describe("buildCostOutputSnapshotRows", () => {
  it("每条 cost 记录生成 12 行（12 个指标键）", () => {
    ...
    // 所有行的 metric_type 都是 cost_output
    for (const r of rows) {
