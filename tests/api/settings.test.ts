  ...
  describe("PUT /api/settings", () => {
    it("switches default model alias and persists override", async () => {
      ...
      const pool = buildModelPool("fast", [
        { config: { alias: "fast", provider: "openai", model: "gpt-4o-mini", handoffThresholdTokens: 100_000 }, model: { id: "mini" } as never },
        { config: { alias: "powerful", provider: "anthropic", model: "claude-sonnet-4-20250514", handoffThresholdTokens: 100_000 }, model: { id: "claude" } as never },
      ]);
