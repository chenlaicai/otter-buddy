...
export interface EntryRepository {
  ...
  /**
   * F20260913ctlv 彻底切换：原子序号插入——INSERT ... SELECT COALESCE(MAX(sequence_num),0)+1
  ...
  /** F20260913ctlv 批4a：按 metadata.externalId(s) 查重（招聘桥接入站去重，原 messages.findByExternalId） */
