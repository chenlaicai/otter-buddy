 ...
 *
 * F20260910ctlv 批4a：自动恢复登记链路（claimResume → ResumeInterruptedService）
 * 随 messages 停写退役——messages 表不再有 streaming 残留可登记，恢复服务已整删。
 * 本函数保留为防御性清理（万一存量库还有旧 streaming 孤儿，仍被置 failed）。
 */
